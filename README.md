...
수업 종료 시간이 아니면 프로그램이 종료되지 않게하여 수업시간을 지킬 수 있게 함</br>
...
![image](https://user-images.githubusercontent.com/90231631/145074452-76f632c6-6ba4-4bff-87d5-191fc1dc1d51.png)</br>
...
#### 출석시작 버튼 이벤트
![image](https://user-images.githubusercontent.com/90231631/145208693-6251c756-a9f1-4539-ae4a-bf6ecac67751.png)
</br>교시와 주차를 세션 메서드로 전달에 서버에 전송
#### 서버에 출석 요청을 보내는 메서드
![image](https://user-images.githubusercontent.com/90231631/145208843-6dfc77d9-2cda-452d-94dc-68d3e829c3be.png)
</br>버튼을 누르면 서버에 출석 요청을 하고 버튼이 사라짐
#### 타이머 메서드(교시가 시작되는 시간에 출석체크, 학생 질문이 오는지 감지 )
![image](https://user-images.githubusercontent.com/90231631/145209116-70f42e5e-65e5-4729-b922-a1e42e3251b0.png)
</br>윗 부분은 교시가 시작되는 시간마다 출석체크 버튼을 띄워주고 </br>
종료 5분전에는 수업종료 버튼을 띄워줌</br>
아래 부분은 학생 질문이 들어오면 질문 폼을 띄워줌
##### 학생 질문 폼
![image](https://user-images.githubusercontent.com/90231631/145209785-be28bfd8-f1a7-4b24-8ae7-aa842cc90c5c.png)
#### 수업 종료 버튼 이벤트
![image](https://user-images.githubusercontent.com/90231631/145209958-d62747a0-8118-437f-94a8-319f47621c33.png)
</br>수업 종료 요청을 서버에 보내는 메서드를 호출하고</br>
폼을 닫음
#### 폼 닫기 이벤트
![image](https://user-images.githubusercontent.com/90231631/145210066-7c94cb18-bb8a-4485-a587-c6b26d8f63a0.png)
</br>종료버튼으로 종료하는게 아닐 시 꺼지지 않게하고 로그인폼도 닫음
#### 트레이 아이콘 부분 이벤트
![image](https://user-images.githubusercontent.com/90231631/145210204-df493837-260b-48cf-a5e9-10ddaa0ed3a3.png)
...
#### 필요한 기능들을 모아둔 클래스(Tool.cs)
##### 이미지 크기 변환하는 메서드
![image](https://user-images.githubusercontent.com/90231631/145208399-9e3d67bd-c068-4284-8d61-b7227bff87af.png)
##### 현재 요일을 구하는 메서드
![image](https://user-images.githubusercontent.com/90231631/145208530-62ab0bf3-f0f0-431d-bff5-8c1bac67cd81.png)
##### 수업의 주차를 구하는 매서드
![image](https://user-images.githubusercontent.com/90231631/145208615-8035874d-2886-456e-959e-801ed7868b54.png)
