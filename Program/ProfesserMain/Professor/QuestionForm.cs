...
namespace ProgramMain
{
    public partial class QuestionForm : Form
    {
        ...
        public RadioButton _radio_write
        {
            get { return radio_write; }
            set { radio_write = value; }
        }
        public RadioButton _radio_yorn
        {
            get { return radio_yorn; }
            set { radio_yorn = value; }
        }

        public TextBox _tb_question
        {
            get { return tb_question; }
            set { tb_question = value; }
        }
        ...
        private void Question_form_Load(object sender, EventArgs e)
        {
            ...
            {
                if (!ProfesserMain.professerMain._studList.Rows[i].ReadOnly){//접속학생만 추가) 
                    this.dataGridView1.Rows.Add(ProfesserMain.professerMain._studList.Rows[i].Cells[0].Value, ProfesserMain.professerMain._studList.Rows[i].Cells[2].Value,
        ...
        {
            //폼 닫기
            radio_write.Checked = false;
            radio_yorn.Checked = false;
            this.Close();
        }
